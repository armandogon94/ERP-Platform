...
MIDDLEWARE = [
    ...
    "core.middleware.CompanyRoleContextMiddleware",
...
# Database
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://erp_user:erp_pass@localhost:5432/erp_dev"),
}
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Multi-tenant ERP platform serving 10 industries with 13 modules.",
    "VERSION": "1.0.0",
}
